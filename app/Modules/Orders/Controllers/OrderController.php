<?php
namespace AwCore\Modules\Orders\Controllers;
...
//use AwCore\Modules\Orders\Orders as Orders;
...
class OrderController extends BaseController
{
	...
	public function getIndex() {
        ...
        $this->doLayout("orders.list", "OrdersView")
                ->with("orders", $orders);
    }
    ...
    public function getView($id) {
        ...
        $this->doLayout("orders.view", "OrdersView")
        		->with("order", $order)
    ...
    public function getEdit($id) {
        ...
        $this->doLayout("orders.edit", "OrdersView")
                ->with("cust", $cust)
                ->with("order", $order)
