	...
	<div class="col-xs-8">
		...
		<div class="box">
			...
			<div class="box-content">
				<div class="card">
					@if ($order['order_id'])
					{!! HTML::link("orders/edit/".$cust['cust_id'], 'Edit', array('class'=>'btn btn-default pull-right')) !!}
		...
		<div class="box">
			...
			<div class="box-content">
				<div class="card">
					...
					@if (count($contacts) > 0)
						@foreach ($contacts as $contact)
						{!! HTML::link("orders/edit/".$contact['contact_id']."/".$cust['cust_id'], 'Add', array('class'=>'btn btn-default pull-right')) !!}
						<p>
...
{!! HTML::link("orders", "Cancel") !!} - 
{!! HTML::link("order/delete/".$cust['cust_id'], "Delete") !!}
